                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-inner-hp">
                    <div class="footer-middle-hp">
                        <div class="footer-left-hp">
                            <h2><a href="<?php echo get_site_url() ?>/job_list" class="text-white">公開中のお仕事検索</a></h2>
                            <div class="footer-links-hp">
                                ...
                                <ul>
                                    ...
                                    <li><a href="<?php echo get_site_url() ?>/job_list?district_val=栃木県">栃木県</a></li>
                                    <li><a href="<?php echo get_site_url() ?>/job_list?district_val=群馬県">群馬県</a></li>
                                    <li><a href="<?php echo get_site_url() ?>/job_list?district_val=埼玉県">埼玉県</a></li>
                        ...
                        <div class="footer-right-hp">
                            ...
                            <div class="footer-btn-hp">
                                <div class="footer-btn-in-hp">
                                    <a href="<?php echo get_site_url()?>/consultation_form"
                                        class="common-btn-hp gradiant_1">相談する</a>
                                </div>
                                <div class="footer-btn-in-hp">
                                    <a href="<?php echo get_site_url()?>/registration_form"
                                        class="common-btn-hp gradiant_2">登録する</a>
                                </div>
                            </div>
                        </div>
