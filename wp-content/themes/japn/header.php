                                ...
                                <nav class="navbar navbar-expand-lg navbar-light">
                                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="<?php echo get_site_url() ?>/job_list">お仕事情報
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link"
                                                    href="<?php echo get_site_url() ?>/informations">コラム</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <div class="header-right-hp">
                                        <div class="contact-btn-main-hp">
                                            <a href="<?php echo get_site_url() ?>/consultation_form"
                                                class="contact-btn-hp">相談する</a>
                                        </div>
                                        <div class="contact-btn-main-hp">
                                            <a href="<?php echo get_site_url() ?>/registration_form"
                                                class="contact-btn-hp doc-btn-hp">登録する </a>
                                        </div>
                                    </div>
                                </nav>
                            </div>
