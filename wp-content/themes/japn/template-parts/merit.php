...
<main id="primary" class="site-main">
    ...
    <section id="contain">
        ...
        <div class="inner-page-main-ip">
                                ...
                                <div class="banner-middle-ip">
                                    <div class="breadcrumb-ip">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">昼ナビ利用の３つのメリット</li>
                                        </ol>
                                    </div>
            ...
            <div class="about-block-ip merit-block-mp">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 about-block-in-ip">
                            <div class="about-middle-ip">
                                <div class="about-left-ip">
                                    <div class="merit-precess-mp">
                                        <div class="merit-title-mp">
                                            <h2><span>H</span>iru Navi <span>M</span>erit</h2>
                                            <p>昼ナビ利用の３つのメリット</p>
                                        </div>
