                                ...
                                <div class="banner-middle-ip">
                                    <div class="breadcrumb-ip">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">アフターフォロー</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="interview-box-op">
                                        ...
                                        <div class="interview-box-middle-op">
                                            <div class="interview-title-op">
                                                <div class="interview-title-left-op">入社後のフォロー体制について</div>
                                                <div class="interview-title-right-op">Follow-up Service</div>
                                            </div>
                                            <div class="interview-info-op">
                                                <p>
                                                    仕事を紹介して入社が決まったら関係は終わり、そんな事はありません。<br>
                                                    新しい職場になじみ、自分らしくイキイキと働ける。そして自分の能力を発揮して活躍ができる。これが転職のゴールだと思っています。昼ナビでは、就職が決まってからも引き続き1人1人に寄り添いサポートしていきます。<br>
                                                    電話やラインで、いつでもお気軽にご連絡ください。
                                                </p>
                                            </div>
                                        </div>
                                        <div class="about-box-border-bottom-ip"></div>
                                    </div>
                                    <div class="interview-list-main-op flow-list-main-fp">
                                        <div class="interview-list-in-op">
                                            <div class="interview-list-op">
                                                ...
                                                <div class="interview-list-right-op">
                                                    <h4>入社当日</h4>
                                                    <p>会社の雰囲気はどうだったか、一緒に働く人はどんな人が多いか、など正直に思った事をお伝えください。転職活動終了後は、社会人同士の友達のように思ってもらって大丈夫なので、お気軽に相談してくださいね！実際に求職者だった方と仲良くなって飲みに行く事や、業種や職種によっては企業同士としての付き合いになる事もあるんです。
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="interview-list-op">
                                                ...
                                                <div class="interview-list-left-op">
                                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/inter_img6.png"
                                                        alt="" />
                                                </div>
                                                <div class="interview-list-right-op">
                                                    <h4>入社1週間後</h4>
                                                    <p>「職場に上手くなじめない…」「仕事がうまくいかない…」など、実際の業務を行う事で生じる悩みってきっとあるはず。そんな時はいつでも私たちを頼ってくださいね。人間関係や、会社の人には言いづらい悩みでつまづいた時など、いつでも相談にのります。また新しい職場に入社して、「聞いていた業務内容と違う」「事前に提示された採用条件と異なる」などといった問題が、も
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="interview-list-op">
                                                ...
                                                <div class="interview-list-left-op">
                                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/inter_img7.png"
                                                        alt="" />
                                                </div>
                                                <div class="interview-list-right-op">
                                                    <h4>入社1ヶ月後</h4>
                                                    <p>日々の業務に慣れてきた頃だと思います。実務を行っていく中でこの先も仕事を続けられそうか、将来のキャリアビジョンはここで叶える事ができそうか、納得して入社しても不安に思う事もあるかもしれません。不安はそのままにせず、当社のキャリアアドバイザーに1度ご相談ください。後悔しない道に進む事ができるよう、長期的な視点でアドバイスします。
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="interview-list-op">
                                                ...
                                                <div class="interview-list-left-op">
                                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/inter_img8.png"
                                                        alt="" />
                                                </div>
                                                <div class="interview-list-right-op">
                                                    <h4>キャリアアドバイザーではなく、1人の友達として</h4>
                                                    <p>昼職で安心して働く事ができるように、入社後のフォローをしっかりと行っていきます。転職が終わったら、あなたを"求職者"というより"1人の社会人の友達"だと考えています。どんな悩みでも、いつでも相談にのるので「転職期間終わったからなぁ」とためらう必要はありません。自分の友達にラインする感覚で、いつでもご連絡くださいね。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
